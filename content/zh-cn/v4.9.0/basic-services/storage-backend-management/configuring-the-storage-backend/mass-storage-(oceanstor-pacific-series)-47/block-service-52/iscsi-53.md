...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p196817363396"><a name="p196817363396"></a><a name="p196817363396"></a>固定填写：fusionstorage-san</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="37.771685921284515%" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0000001324610777_p430691742216"><a name="zh-cn_topic_0000001324610777_p430691742216"></a><a name="zh-cn_topic_0000001324610777_p430691742216"></a>存储设备的管理URL。参数格式为列表。</p>
</td>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p817413718164"><a name="p817413718164"></a><a name="p817413718164"></a>支持按照域名或者IP+端口的方式进行配置。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul555819319152"></a><a name="ul555819319152"></a><ul id="ul555819319152"><li>固定填写：iscsi</li><li>请确保对接的计算节点已安装iSCSI客户端。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul523352818617"></a><a name="ul523352818617"></a><ul id="ul523352818617"><li>支持配置多个端口。</li><li>iscsiLinks与portals参数必须配置其中一项。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="37.771685921284515%" headers="mcps1.2.6.1.2 "><p id="p1462551761911"><a name="p1462551761911"></a><a name="p1462551761911"></a>动态访问链接数，仅支持Pacific 8.1.5及以上版本。</p>
</td>
<td class="cellrowborder" valign="top" width="7.1176816134717065%" headers="mcps1.2.6.1.3 "><p id="p186256177191"><a name="p186256177191"></a><a name="p186256177191"></a>条件必选</p>
</td>
<td class="cellrowborder" valign="top" width="6.8533385549246155%" headers="mcps1.2.6.1.4 ">&nbsp;&nbsp;</td>
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p6625717141910"><a name="p6625717141910"></a><a name="p6625717141910"></a>iscsiLinks与portals参数必须配置其中一项。</p>
<div class="note" id="note068192619527"><a name="note068192619527"></a><a name="note068192619527"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ol56967115249"></a><a name="ol56967115249"></a><ol id="ol56967115249"><li>仅当portals参数为空时，iscsiLinks参数生效。</li><li>实际生效的链路数为以下三者的最大值：<a name="ul2753522162518"></a><a name="ul2753522162518"></a><ul id="ul2753522162518"><li>iscsiLinks参数值</li><li>存储动态分配最小链路数</li><li>主机上已建连的链接数</li></ul>
</li></ol>
</div></div>
</td>
</tr>
