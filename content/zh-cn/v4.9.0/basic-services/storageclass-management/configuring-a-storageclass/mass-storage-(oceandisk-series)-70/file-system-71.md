...
<th class="cellrowborder" valign="top" width="7.191077194012327%" id="mcps1.2.7.1.5"><p id="p1113325565918"><a name="p1113325565918"></a><a name="p1113325565918"></a>纳管卷是否生效</p>
</th>
<th class="cellrowborder" valign="top" width="35.93581841307113%" id="mcps1.2.7.1.6"><p id="zh-cn_topic_0000001162111564_p075011113295"><a name="zh-cn_topic_0000001162111564_p075011113295"></a><a name="zh-cn_topic_0000001162111564_p075011113295"></a>备注</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p16133655135913"><a name="p16133655135913"></a><a name="p16133655135913"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="zh-cn_topic_0000001162111564_p861713973915"><a name="zh-cn_topic_0000001162111564_p861713973915"></a><a name="zh-cn_topic_0000001162111564_p861713973915"></a>以Kubernetes v1.22.1为例，支持数字、小写字母、中划线（-）和点（.）的组合，并且必须以字母数字开头和结尾。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p0133955185920"><a name="p0133955185920"></a><a name="p0133955185920"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p848811314350"><a name="p848811314350"></a><a name="p848811314350"></a>该字段需要指定为安装华为CSI时设置的驱动名称。</p>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p11332055125915"><a name="p11332055125915"></a><a name="p11332055125915"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><a name="ul94333519558"></a><a name="ul94333519558"></a><ul id="ul94333519558"><li>Delete：删除PV/PVC时会关联删除存储上的资源。</li><li>Retain：删除PV/PVC时不会删除存储上的资源。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p1613325519595"><a name="p1613325519595"></a><a name="p1613325519595"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p13923171118495"><a name="p13923171118495"></a><a name="p13923171118495"></a>此功能仅可用于扩容PV，不能用于缩容PV。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p1613355555915"><a name="p1613355555915"></a><a name="p1613355555915"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p15432162772912"><a name="p15432162772912"></a><a name="p15432162772912"></a>常见的mountOptions参数参考<a href="#table65545557506">表2</a>。</p>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p413315519590"><a name="p413315519590"></a><a name="p413315519590"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p2023133002520"><a name="p2023133002520"></a><a name="p2023133002520"></a>如果不设置，华为CSI随机选择一个满足容量要求的后端创建资源。</p>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p91331855155916"><a name="p91331855155916"></a><a name="p91331855155916"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p99571317978"><a name="p99571317978"></a><a name="p99571317978"></a>如果不设置，华为CSI会在所选后端上随机选择一个满足容量要求的存储池创建资源。建议指定存储池，确保创建的资源在预期的存储池上。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p0133205515597"><a name="p0133205515597"></a><a name="p0133205515597"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><a name="ul165061538173414"></a><a name="ul165061538173414"></a><ul id="ul165061538173414"><li>支持配置字母、数字、"-"、"_"、"."，不能配置为空，且将占位符展开后的长度范围是1-255。</li><li>必须同时配置PVC命名空间和PVC名称。</li><li>为了避免资源名称重复，会将PVC UID作为唯一标识符默认添加到名称末尾。</li></ul>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p1913415525920"><a name="p1913415525920"></a><a name="p1913415525920"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p159151023181412"><a name="p159151023181412"></a><a name="p159151023181412"></a>此处固定配置为fs。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p1134955145917"><a name="p1134955145917"></a><a name="p1134955145917"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="zh-cn_topic_0000001162111564_p57502011142910"><a name="zh-cn_topic_0000001162111564_p57502011142910"></a><a name="zh-cn_topic_0000001162111564_p57502011142910"></a>配置为thin时，创建卷不会立即分配所有需要的空间，而是根据使用情况动态分配。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p1637013765210"><a name="p1637013765210"></a><a name="p1637013765210"></a>必选</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p16134125519590"><a name="p16134125519590"></a><a name="p16134125519590"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p466615315578"><a name="p466615315578"></a><a name="p466615315578"></a>可以使用“*”表示任意客户端。当您不确定访问客户端IP信息时，建议使用“*”防止客户端访问被存储拒绝。</p>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p213412554593"><a name="p213412554593"></a><a name="p213412554593"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="zh-cn_topic_0000001162111564_p1775091110298"><a name="zh-cn_topic_0000001162111564_p1775091110298"></a><a name="zh-cn_topic_0000001162111564_p1775091110298"></a>4速度最快。配置克隆持久卷或从快照创建持久卷时生效。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p113415510596"><a name="p113415510596"></a><a name="p113415510596"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p1795516502165"><a name="p1795516502165"></a><a name="p1795516502165"></a>在DeviceManager管理界面，选择“服务 &gt; 文件服务 &gt; 文件系统 &gt; 创建 &gt; 应用类型”，获取应用类型名称。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p813405513593"><a name="p813405513593"></a><a name="p813405513593"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p24789316192"><a name="p24789316192"></a><a name="p24789316192"></a>支持的QoS配置请参考<a href="#table1315616262719">表3</a>说明。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p101341755105914"><a name="p101341755105914"></a><a name="p101341755105914"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p18909114043117"><a name="p18909114043117"></a><a name="p18909114043117"></a>配置格式参考Linux权限设置，如“777”、“755”等。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p1413416553593"><a name="p1413416553593"></a><a name="p1413416553593"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p11134115595916"><a name="p11134115595916"></a><a name="p11134115595916"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 ">&nbsp;&nbsp;</td>
</tr>
...
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p577912382417"><a name="p577912382417"></a><a name="p577912382417"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p111342055115917"><a name="p111342055115917"></a><a name="p111342055115917"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p15292191316454"><a name="p15292191316454"></a><a name="p15292191316454"></a>挂载时，可以在mountOptions中指定参数sec。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p129331245154111"><a name="p129331245154111"></a><a name="p129331245154111"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p1713445513599"><a name="p1713445513599"></a><a name="p1713445513599"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p787455154620"><a name="p787455154620"></a><a name="p787455154620"></a>挂载时，可以在mountOptions中指定参数sec。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p1780134314118"><a name="p1780134314118"></a><a name="p1780134314118"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p131341955105920"><a name="p131341955105920"></a><a name="p131341955105920"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p1132519619463"><a name="p1132519619463"></a><a name="p1132519619463"></a>挂载时，可以在mountOptions中指定参数sec。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p101347555596"><a name="p101347555596"></a><a name="p101347555596"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p1346853212219"><a name="p1346853212219"></a><a name="p1346853212219"></a>仅支持NAS存储。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p3370167175211"><a name="p3370167175211"></a><a name="p3370167175211"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p16134155555910"><a name="p16134155555910"></a><a name="p16134155555910"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p3134555195918"><a name="p3134555195918"></a><a name="p3134555195918"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p0723450135618"><a name="p0723450135618"></a><a name="p0723450135618"></a>OceanDisk的扇区大小为512 B。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p14134105525910"><a name="p14134105525910"></a><a name="p14134105525910"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 ">&nbsp;&nbsp;</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.191077194012327%" headers="mcps1.2.7.1.5 "><p id="p17135555145910"><a name="p17135555145910"></a><a name="p17135555145910"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.93581841307113%" headers="mcps1.2.7.1.6 "><p id="p208761647111216"><a name="p208761647111216"></a><a name="p208761647111216"></a>支持的高级参数列表请参考<a href="#_table034918373916">表4</a>说明。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p328516567514"><a name="p328516567514"></a><a name="p328516567514"></a>nfsvers：挂载NFS时的协议版本。支持配置的参数值为“3”，“4.0”。</p>
</td>
...
<p id="p13285856115110"><a name="p13285856115110"></a><a name="p13285856115110"></a>指定NFS版本挂载时，当前支持NFS 3/4.0协议（需存储设备支持且开启）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.5 "><a name="ul1028516561513"></a><a name="ul1028516561513"></a><ul id="ul1028516561513"><li>使用Kerberos 5协议时，请配置krb5。</li><li>使用Kerberos 5i协议时，请配置krb5i。</li><li>使用Kerberos 5p协议时，请配置krb5p。</li><li>仅NFS v4.0支持Kerberos</li></ul>
</td>
</tr>
