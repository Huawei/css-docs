...
待变更PVC关联的存储后端已经组成双活存储后端，若未组成双活存储后端，请参考[更新存储后端信息](/docs/basic-services/storage-backend-management/managing-storage-backends/updating-a-storage-backend/updating-a-storage-backend-75)章节配置。
...
3.  参考[查询PVC变更](/docs/basic-services/persistent-volume-management/managing-pvs-91/changing-a-pv/configuring-pvc-changes/querying-a-pvc-change)查询创建结果。
