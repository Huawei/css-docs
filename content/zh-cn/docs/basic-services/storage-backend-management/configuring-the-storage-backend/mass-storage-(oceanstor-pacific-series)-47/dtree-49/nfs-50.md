...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="zh-cn_topic_0000001324610777_p17339174424512"><a name="zh-cn_topic_0000001324610777_p17339174424512"></a><a name="zh-cn_topic_0000001324610777_p17339174424512"></a>固定填写：fusionstorage-dtree</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="37.771685921284515%" headers="mcps1.2.6.1.2 "><p id="p1518094762719"><a name="p1518094762719"></a><a name="p1518094762719"></a>存储侧的账户名称。</p>
</td>
<td class="cellrowborder" valign="top" width="7.1176816134717065%" headers="mcps1.2.6.1.3 "><p id="p1237175019184"><a name="p1237175019184"></a><a name="p1237175019184"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p195481349369"><a name="p195481349369"></a><a name="p195481349369"></a>需要在指定账户下发放NAS资源时，需要指定该参数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p9969155711201"><a name="p9969155711201"></a><a name="p9969155711201"></a>支持按照域名或者IP+端口的方式进行配置。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul73520114122"></a><a name="ul73520114122"></a><ul id="ul73520114122"><li>使用账户对接后端时，此时portals必须配置为账户所拥有的逻辑端口信息。</li><li>支持填写为域名地址。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul79421446192713"></a><a name="ul79421446192713"></a><ul id="ul79421446192713"><li>请到DeviceManager文件系统界面查询。</li><li>可选择在StorageClass中配置</li></ul>
</td>
</tr>
