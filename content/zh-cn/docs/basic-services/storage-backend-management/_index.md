...
-   使用oceanctl工具前请确保oceanctl工具版本与CSI版本相同。查看oceanctl版本命令参考[帮助说明](/docs/command-parameter-description/description-of-oceanctl-commands#section1117411442508)。当前版本号应为：V4.11.0。
