...
<th class="cellrowborder" valign="top" width="7.347617649936406%" id="mcps1.2.7.1.5"><p id="p8234164912813"><a name="p8234164912813"></a><a name="p8234164912813"></a>纳管卷是否生效</p>
</th>
<th class="cellrowborder" valign="top" width="35.77927795714705%" id="mcps1.2.7.1.6"><p id="zh-cn_topic_0000001162111564_p075011113295"><a name="zh-cn_topic_0000001162111564_p075011113295"></a><a name="zh-cn_topic_0000001162111564_p075011113295"></a>备注</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p423412492080"><a name="p423412492080"></a><a name="p423412492080"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="zh-cn_topic_0000001162111564_p861713973915"><a name="zh-cn_topic_0000001162111564_p861713973915"></a><a name="zh-cn_topic_0000001162111564_p861713973915"></a>以Kubernetes v1.22.1为例，支持数字、小写字母、中划线（-）和点（.）的组合，并且必须以字母数字开头和结尾。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p14234949683"><a name="p14234949683"></a><a name="p14234949683"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p848811314350"><a name="p848811314350"></a><a name="p848811314350"></a>该字段需要指定为安装华为CSI时设置的驱动名称。</p>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p423410493811"><a name="p423410493811"></a><a name="p423410493811"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><a name="ul94333519558"></a><a name="ul94333519558"></a><ul id="ul94333519558"><li>Delete：删除PV/PVC时会关联删除存储上的资源。</li><li>Retain：删除PV/PVC时不会删除存储上的资源。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p1423416491387"><a name="p1423416491387"></a><a name="p1423416491387"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p13923171118495"><a name="p13923171118495"></a><a name="p13923171118495"></a>此功能仅可用于扩容PV，不能用于缩容PV。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p12341949782"><a name="p12341949782"></a><a name="p12341949782"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p15432162772912"><a name="p15432162772912"></a><a name="p15432162772912"></a>常见的mountOptions参数参考<a href="#table65545557506">表2</a>。</p>
...
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p2201185318312"><a name="p2201185318312"></a><a name="p2201185318312"></a>待创建资源所在的后端名称。</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p152341491286"><a name="p152341491286"></a><a name="p152341491286"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p2023133002520"><a name="p2023133002520"></a><a name="p2023133002520"></a>如果不设置，华为CSI随机选择一个满足容量要求的后端创建资源。</p>
...
<tr id="row9425191220356"><td class="cellrowborder" valign="top" width="18.481557577536446%" headers="mcps1.2.7.1.1 "><p id="p122751558184511"><a name="p122751558184511"></a><a name="p122751558184511"></a><span>parameters.</span>parentname</p>
</td>
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p327525817451"><a name="p327525817451"></a><a name="p327525817451"></a>当前存储上的某一个文件系统名称，在此文件系统下创建Dtree。</p>
</td>
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p8275125812453"><a name="p8275125812453"></a><a name="p8275125812453"></a>条件必选</p>
</td>
<td class="cellrowborder" valign="top" width="8.453184619900206%" headers="mcps1.2.7.1.4 "><p id="p327535812450"><a name="p327535812450"></a><a name="p327535812450"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p1023420491589"><a name="p1023420491589"></a><a name="p1023420491589"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p16731411944"><a name="p16731411944"></a><a name="p16731411944"></a>当backend未配置parentname时，该参数必填。</p>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p845812615184"><a name="p845812615184"></a><a name="p845812615184"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p159151023181412"><a name="p159151023181412"></a><a name="p159151023181412"></a>使用Dtree时，必须为dtree。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p1823419491485"><a name="p1823419491485"></a><a name="p1823419491485"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p466615315578"><a name="p466615315578"></a><a name="p466615315578"></a>可以使用“*”表示任意客户端。当您不确定访问客户端IP信息时，建议使用“*”防止客户端访问被存储拒绝。</p>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p1023414493812"><a name="p1023414493812"></a><a name="p1023414493812"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p18909114043117"><a name="p18909114043117"></a><a name="p18909114043117"></a>配置格式参考Linux权限设置，如“777”、“755”等。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p1823420491088"><a name="p1823420491088"></a><a name="p1823420491088"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 ">&nbsp;&nbsp;</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p16234949086"><a name="p16234949086"></a><a name="p16234949086"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 ">&nbsp;&nbsp;</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.347617649936406%" headers="mcps1.2.7.1.5 "><p id="p1923424914810"><a name="p1923424914810"></a><a name="p1923424914810"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.77927795714705%" headers="mcps1.2.7.1.6 "><p id="p52910516599"><a name="p52910516599"></a><a name="p52910516599"></a>OceanStor Pacific Dtree的扇区大小为1 B。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p494142514512"><a name="p494142514512"></a><a name="p494142514512"></a>nfsvers：挂载NFS时的协议版本。支持配置的参数值为“3”，“4.1”。</p>
</td>
...
<p id="p1094162515515"><a name="p1094162515515"></a><a name="p1094162515515"></a>指定NFS版本挂载时，当前支持NFS 3/4.1协议（需存储设备支持且开启）。</p>
</td>
</tr>
