...
当容器使用OceanStor A系列存储，且存储支持KVCache功能时，nfs协议可以参考如下配置示例。KVCache也支持dtfs协议，具体配置参考参数详细说明。
...
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p19628175610227"><a name="p19628175610227"></a><a name="p19628175610227"></a>是否创建KVCache库。</p>
<a name="ul277414531950"></a><a name="ul277414531950"></a><ul id="ul277414531950"><li>"false":关闭。</li><li>"true":开启。</li></ul>
</td>
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p31521527152220"><a name="p31521527152220"></a><a name="p31521527152220"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.35740142843166%" headers="mcps1.2.7.1.5 "><p id="p20508115831514"><a name="p20508115831514"></a><a name="p20508115831514"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.7694941786518%" headers="mcps1.2.7.1.6 "><p id="p119704559154"><a name="p119704559154"></a><a name="p119704559154"></a>当配置为"true"时, parameters.applicationType只能配置为NAS_AI_Inference或者为空。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p220093184917"><a name="p220093184917"></a><a name="p220093184917"></a>是否启用KVCache主动清理。</p>
<a name="ul240061210515"></a><a name="ul240061210515"></a><ul id="ul240061210515"><li>"false":关闭。</li><li>"true":开启。</li></ul>
</td>
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p1920063144913"><a name="p1920063144913"></a><a name="p1920063144913"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.35740142843166%" headers="mcps1.2.7.1.5 "><p id="p1200113114920"><a name="p1200113114920"></a><a name="p1200113114920"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.7694941786518%" headers="mcps1.2.7.1.6 "><p id="p13970555181513"><a name="p13970555181513"></a><a name="p13970555181513"></a>无论配置为"true"还是"false"，后台均会在记忆库容量不足时清理KVCache；配置为"true"时，后台会清理过期的KVCache。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p413812361537"><a name="p413812361537"></a><a name="p413812361537"></a>KVCache过期时间，范围1-3650天。示例"1"。</p>
</td>
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p1820073117497"><a name="p1820073117497"></a><a name="p1820073117497"></a>条件必选</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.35740142843166%" headers="mcps1.2.7.1.5 "><p id="p7661579277"><a name="p7661579277"></a><a name="p7661579277"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="35.7694941786518%" headers="mcps1.2.7.1.6 "><p id="p209709556158"><a name="p209709556158"></a><a name="p209709556158"></a>当parameters.enableTimeAwareGc配置为"true"时，本参数必填。</p>
</td>
</tr>
</tbody>
</table>
