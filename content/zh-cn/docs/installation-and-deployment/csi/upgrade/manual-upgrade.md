...
## 2.x和3.x版本的CSI升级至4.11.0版本{#section260220843210}
...
5.  将[2](#li1699321211285)中备份的后端信息，按照[存储后端管理](/docs/basic-services/storage-backend-management)章节的说明安装。其中通过备份后端信息配置存储后端命令如下。

    ```
    oceanctl create backend -f configmap.json -i json -n huawei-csi
    ```

## 从4.x版本的CSI升级至4.11.0版本。{#section173369363219}
