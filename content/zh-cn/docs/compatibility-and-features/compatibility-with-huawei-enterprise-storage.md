...
<table><thead align="left"><tr id="row6996173914451"><th class="cellrowborder" valign="top" width="24.68%" id="mcps1.2.5.1.1"><p id="p199961439154519"><a name="p199961439154519"></a><a name="p199961439154519"></a>特性</p>
</th>
...
<tbody><tr id="row1899683984519"><td class="cellrowborder" valign="top" width="24.68%" headers="mcps1.2.5.1.1 "><p id="p899653994514"><a name="p899653994514"></a><a name="p899653994514"></a><span>Static Provisioning</span></p>
</td>
...
<p id="p20838142381814"><a name="p20838142381814"></a><a name="p20838142381814"></a>NAS：NFS 3/4.0/4.1/4.2<sup id="sup144486444285"><a name="sup144486444285"></a><a name="sup144486444285"></a>4</sup></p>
</td>
<td class="cellrowborder" rowspan="3" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p115594419186"><a name="p115594419186"></a><a name="p115594419186"></a>SAN<sup id="sup5145135862913"><a name="sup5145135862913"></a><a name="sup5145135862913"></a>2</sup>：FC/iSCSI/NVMe over RoCE/NVMe over FC<sup id="sup58095411283"><a name="sup58095411283"></a><a name="sup58095411283"></a>3</sup></p>
<p id="p12839143282719"><a name="p12839143282719"></a><a name="p12839143282719"></a>NAS：NFS 3/4.0/4.1/4.2<sup id="sup17472164720280"><a name="sup17472164720280"></a><a name="sup17472164720280"></a>4</sup>/NFS+<sup id="sup18808549122814"><a name="sup18808549122814"></a><a name="sup18808549122814"></a>5</sup></p>
</td>
</tr>
...
<tr id="row8996539144513"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p49961939194517"><a name="p49961939194517"></a><a name="p49961939194517"></a><span>Expand Persistent Volume</span><sup id="sup1574255182810"><a name="sup1574255182810"></a><a name="sup1574255182810"></a>6</sup></p>
</td>
...
<td class="cellrowborder" valign="top" width="23.28%" headers="mcps1.2.5.1.2 "><p id="p2996153934511"><a name="p2996153934511"></a><a name="p2996153934511"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="25.55%" headers="mcps1.2.5.1.3 "><p id="p10996183911451"><a name="p10996183911451"></a><a name="p10996183911451"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p111601529121812"><a name="p111601529121812"></a><a name="p111601529121812"></a>支持</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="23.28%" headers="mcps1.2.5.1.2 "><p id="p149971339154511"><a name="p149971339154511"></a><a name="p149971339154511"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="25.55%" headers="mcps1.2.5.1.3 "><p id="p199713910459"><a name="p199713910459"></a><a name="p199713910459"></a>SAN：支持</p>
<p id="p33033201414"><a name="p33033201414"></a><a name="p33033201414"></a>NAS：仅6.1.5及其之后版本支持</p>
</td>
<td class="cellrowborder" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p193754331128"><a name="p193754331128"></a><a name="p193754331128"></a>SAN：支持</p>
...
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p17444111738"><a name="p17444111738"></a><a name="p17444111738"></a>SAN：支持使用Dynamic Provisioning，Manage Provisioning方式创建的非双活卷</p>
...
<td class="cellrowborder" valign="top" width="23.28%" headers="mcps1.2.5.1.2 "><p id="p7539162811719"><a name="p7539162811719"></a><a name="p7539162811719"></a>仅支持SAN类型的卷</p>
</td>
<td class="cellrowborder" valign="top" width="25.55%" headers="mcps1.2.5.1.3 "><p id="p1353952811711"><a name="p1353952811711"></a><a name="p1353952811711"></a>仅支持SAN类型的卷</p>
</td>
<td class="cellrowborder" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p153913281879"><a name="p153913281879"></a><a name="p153913281879"></a>仅支持SAN类型的卷</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="23.28%" headers="mcps1.2.5.1.2 "><p id="p18667138181019"><a name="p18667138181019"></a><a name="p18667138181019"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="25.55%" headers="mcps1.2.5.1.3 "><p id="p106676821018"><a name="p106676821018"></a><a name="p106676821018"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p166671688101"><a name="p166671688101"></a><a name="p166671688101"></a>支持</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="23.28%" headers="mcps1.2.5.1.2 "><p id="p2091319219390"><a name="p2091319219390"></a><a name="p2091319219390"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="25.55%" headers="mcps1.2.5.1.3 "><p id="p1691418293913"><a name="p1691418293913"></a><a name="p1691418293913"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p18914028397"><a name="p18914028397"></a><a name="p18914028397"></a>支持</p>
</td>
</tr>
...
<td class="cellrowborder" colspan="3" valign="top" headers="mcps1.2.5.1.2 mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p69001214125219"><a name="p69001214125219"></a><a name="p69001214125219"></a><span>RWO/ROX/RWOP：</span>所有类型卷均支持，<span>RWOP</span>需<span>Kubernetes 1.22</span>版本以上支持。</p>
...
<td class="cellrowborder" valign="top" width="23.28%" headers="mcps1.2.5.1.2 "><p id="p1374918324264"><a name="p1374918324264"></a><a name="p1374918324264"></a>支持<sup id="sup171801649292"><a name="sup171801649292"></a><a name="sup171801649292"></a>7</sup></p>
</td>
<td class="cellrowborder" valign="top" width="25.55%" headers="mcps1.2.5.1.3 "><p id="p8749203242620"><a name="p8749203242620"></a><a name="p8749203242620"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p19749123216264"><a name="p19749123216264"></a><a name="p19749123216264"></a>支持</p>
</td>
</tr>
<tr id="row13606622132720"><td class="cellrowborder" valign="top" width="24.68%" headers="mcps1.2.5.1.1 "><p id="p1760612292716"><a name="p1760612292716"></a><a name="p1760612292716"></a>应用类型</p>
</td>
<td class="cellrowborder" valign="top" width="23.28%" headers="mcps1.2.5.1.2 "><p id="p1960652212711"><a name="p1960652212711"></a><a name="p1960652212711"></a>不涉及</p>
</td>
<td class="cellrowborder" valign="top" width="25.55%" headers="mcps1.2.5.1.3 "><p id="p1360619224273"><a name="p1360619224273"></a><a name="p1360619224273"></a>支持</p>
</td>
<td class="cellrowborder" valign="top" width="26.490000000000002%" headers="mcps1.2.5.1.4 "><p id="p1960622242718"><a name="p1960622242718"></a><a name="p1960622242718"></a>支持</p>
</td>
</tr>
<tr id="row17943182222817"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p79432225287"><a name="p79432225287"></a><a name="p79432225287"></a>卷双活<sup id="sup129559632918"><a name="sup129559632918"></a><a name="sup129559632918"></a>8</sup></p>
</td>
...
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p794313221284"><a name="p794313221284"></a><a name="p794313221284"></a>仅支持NAS类型的卷</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.5.1.2 "><p id="p177194510519"><a name="p177194510519"></a><a name="p177194510519"></a>仅支持NAS类型的卷</p>
</td>
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p15191349103613"><a name="p15191349103613"></a><a name="p15191349103613"></a>仅支持NAS类型的卷<sup id="sup66611711142913"><a name="sup66611711142913"></a><a name="sup66611711142913"></a>9</sup></p>
</td>
</tr>
</tbody>
</table>
...
-   注释2 若用户的容器平台部署在虚拟化平台上，对接SAN存储时建议使用iSCSI协议。若客户要求使用FC/NVMe over FC/NVMe over RoCE协议，需要对虚拟化平台进行特定配置，需客户侧的虚拟化团队提供技术支持。
-   注释3 使用NVMe over RoCE或NVMe over FC时，worker节点nvme-cli工具版本为1.9\~1.16，查询命令为：nvme version。
...
-   注释5 OceanStor Dorado 6.1.7及以后版本支持NFS+。
-   注释6 发放的volumeType为lun且accessModes为ReadOnlyMany的PVC不支持扩容。
-   注释7 仅系统用户支持配置QoS。
-   注释8 仅支持AA双活。
-   注释9 仅OceanStor/OceanStor Dorado 6.1.3及以后版本支持多租户。
