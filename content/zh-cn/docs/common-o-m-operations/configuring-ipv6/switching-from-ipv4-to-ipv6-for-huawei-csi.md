...
2.  执行**vi update-values.yaml**命令打开[1](#li19355236151916)中获取的文件，修改service.ipFamilyPolicy和service.ipFamilies配置项，具体参数描述见[表5](/docs/installation-and-deployment/csi/installation/installation-using-helm/parameters-in-the-values-yaml-file-of-helm#table258712427285)。
