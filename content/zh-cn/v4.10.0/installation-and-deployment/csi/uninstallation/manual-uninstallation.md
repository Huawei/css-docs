...
如果[安装时未使用CSIDriver特性](/docs/installation-and-deployment/csi/installation/manual-installation#li395973220487)，可跳过本步骤。
...
-   卸载huawei-csi-host-info对象，请参考[卸载huawei-csi-host-info对象](/docs/installation-and-deployment/csi/uninstallation/uninstallation-using-helm/uninstalling-csi-dependent-component-services#section870813403017)进行操作。
-   卸载webhook资源，请参考[卸载Webhook资源](/docs/installation-and-deployment/csi/uninstallation/uninstallation-using-helm/uninstalling-csi-dependent-component-services#section871155813014)进行操作。
-   （可选）卸载快照依赖组件服务，请参考[卸载Snapshot依赖组件服务](/docs/installation-and-deployment/csi/uninstallation/uninstallation-using-helm/uninstalling-csi-dependent-component-services#section48371491319)进行操作。
-   （可选）卸载Lease资源，请参考[卸载Lease资源](/docs/installation-and-deployment/csi/uninstallation/uninstallation-using-helm/uninstalling-csi-dependent-component-services#section263805014317)进行操作。
