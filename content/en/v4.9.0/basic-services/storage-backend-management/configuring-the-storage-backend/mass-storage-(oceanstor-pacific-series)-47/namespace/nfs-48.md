...
<td class="cellrowborder" valign="top" width="7.1176816134717065%" headers="mcps1.2.6.1.3 "><p id="p13839114220182"><a name="p13839114220182"></a><a name="p13839114220182"></a>No</p>
</td>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul73520114122"></a><a name="ul73520114122"></a><ul id="ul73520114122"><li>If an account is used to connect to a backend, <strong id="b52591611333"><a name="b52591611333"></a><a name="b52591611333"></a>portals</strong> must be set to the logical port information of the account.</li><li>You can enter a domain name address.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p7363204412133"><a name="p7363204412133"></a><a name="p7363204412133"></a>The value ranges from <strong id="b7088788424316"><a name="b7088788424316"></a><a name="b7088788424316"></a>1</strong> to <strong id="b1913844764316"><a name="b1913844764316"></a><a name="b1913844764316"></a>30</strong>. If this parameter is not set or the value is not in the specified range, the default value <strong id="b21342514534316"><a name="b21342514534316"></a><a name="b21342514534316"></a>30</strong> is used.</p>
</td>
</tr>
</tbody>
</table>
