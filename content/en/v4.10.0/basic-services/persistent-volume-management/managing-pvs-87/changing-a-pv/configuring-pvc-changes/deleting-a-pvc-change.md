...
3.  Query the deletion result by following the instructions in  [Querying a PVC Change](/docs/basic-services/persistent-volume-management/managing-pvs-87/changing-a-pv/configuring-pvc-changes/querying-a-pvc-change).
