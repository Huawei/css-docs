...
<tr id="row15455936135213"><td class="cellrowborder" valign="top" width="13.266105345604077%" headers="mcps1.2.6.1.1 "><p id="p144552364525"><a name="p144552364525"></a><a name="p144552364525"></a>storageDeviceSN</p>
</td>
<td class="cellrowborder" valign="top" width="37.771685921284515%" headers="mcps1.2.6.1.2 "><p id="p10455236155211"><a name="p10455236155211"></a><a name="p10455236155211"></a>Serial number of the storage device.</p>
</td>
<td class="cellrowborder" valign="top" width="7.1176816134717065%" headers="mcps1.2.6.1.3 "><p id="p645543635218"><a name="p645543635218"></a><a name="p645543635218"></a>Yes</p>
</td>
<td class="cellrowborder" valign="top" width="6.8533385549246155%" headers="mcps1.2.6.1.4 ">&nbsp;&nbsp;</td>
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p13283537205314"><a name="p13283537205314"></a><a name="p13283537205314"></a>On the DME management page, choose <strong id="b14696536163419"><a name="b14696536163419"></a><a name="b14696536163419"></a>Infrastructure</strong> &gt; <strong id="b1869611369349"><a name="b1869611369349"></a><a name="b1869611369349"></a>Storage Devices</strong> &gt; <strong id="b186961036163412"><a name="b186961036163412"></a><a name="b186961036163412"></a>ESN</strong> to obtain the serial number of the storage device.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul555819319152"></a><a name="ul555819319152"></a><ul id="ul555819319152"><li>The value is fixed to <strong id="b7834125620490"><a name="b7834125620490"></a><a name="b7834125620490"></a>dtfs</strong>.</li><li>Ensure that a DataTurbo client has been installed on the connected compute node and the connectivity of the storage logical port has been configured.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p7363204412133"><a name="p7363204412133"></a><a name="p7363204412133"></a>The value ranges from <strong id="b98973965114847"><a name="b98973965114847"></a><a name="b98973965114847"></a>1</strong> to <strong id="b1805397493114847"><a name="b1805397493114847"></a><a name="b1805397493114847"></a>30</strong>. If this parameter is not set or the value is not in the specified range, the default value <strong id="b405012361114847"><a name="b405012361114847"></a><a name="b405012361114847"></a>30</strong> is used.</p>
</td>
</tr>
</tbody>
</table>
