...
<tr id="row9282143705319"><td class="cellrowborder" valign="top" width="13.266105345604077%" headers="mcps1.2.6.1.1 "><p id="p428323713530"><a name="p428323713530"></a><a name="p428323713530"></a>storageDeviceSN</p>
</td>
<td class="cellrowborder" valign="top" width="37.771685921284515%" headers="mcps1.2.6.1.2 "><p id="p172832371535"><a name="p172832371535"></a><a name="p172832371535"></a>Serial number of the storage device.</p>
</td>
<td class="cellrowborder" valign="top" width="7.1176816134717065%" headers="mcps1.2.6.1.3 "><p id="p1283637165319"><a name="p1283637165319"></a><a name="p1283637165319"></a>Yes</p>
</td>
<td class="cellrowborder" valign="top" width="6.8533385549246155%" headers="mcps1.2.6.1.4 ">&nbsp;&nbsp;</td>
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p13283537205314"><a name="p13283537205314"></a><a name="p13283537205314"></a>On the DME management page, choose <strong id="b114813143340"><a name="b114813143340"></a><a name="b114813143340"></a>Infrastructure</strong> &gt; <strong id="b19651017173414"><a name="b19651017173414"></a><a name="b19651017173414"></a>Storage Devices</strong> &gt; <strong id="b12921820123419"><a name="b12921820123419"></a><a name="b12921820123419"></a>ESN</strong> to obtain the serial number of the storage device.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul555819319152"></a><a name="ul555819319152"></a><ul id="ul555819319152"><li>The value is fixed to <strong id="b19773313124813"><a name="b19773313124813"></a><a name="b19773313124813"></a>nfs</strong>.</li><li>Ensure that an NFS client tool has been installed on the connected compute node.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul560416106381"></a><a name="ul560416106381"></a><ul id="ul560416106381"><li>You can enter a domain name address.</li><li>Only one port can be configured.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="6.8533385549246155%" headers="mcps1.2.6.1.4 "><p id="p16919715145113"><a name="p16919715145113"></a><a name="p16919715145113"></a>5</p>
</td>
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p7363204412133"><a name="p7363204412133"></a><a name="p7363204412133"></a>The value ranges from <strong id="b11877448484"><a name="b11877448484"></a><a name="b11877448484"></a>1</strong> to <strong id="b11187154413484"><a name="b11187154413484"></a><a name="b11187154413484"></a>30</strong>. If this parameter is not set or the value is not in the specified range, the default value <strong id="b4187134419483"><a name="b4187134419483"></a><a name="b4187134419483"></a>5</strong> is used.</p>
</td>
</tr>
</tbody>
</table>
...
4.  Check the storage backend creation result.
    ...
    huawei-csi    backend-demo    nfs         oceanstor-a-series-nas  xxxxxxxxxxxxxxxxxxxx  Bound   true    https://192.168.129.157:26335   
    ```
