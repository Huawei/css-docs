...
<table><thead align="left"><tr id="row250245510250"><th class="cellrowborder" valign="top" width="35.339999999999996%" id="mcps1.2.3.1.1"><p id="p10502355102510"><a name="p10502355102510"></a><a name="p10502355102510"></a>Feature</p>
</th>
<th class="cellrowborder" valign="top" width="64.66%" id="mcps1.2.3.1.2"><p id="p150255532517"><a name="p150255532517"></a><a name="p150255532517"></a>OceanStor Pacific Series</p>
</th>
</tr>
</thead>
<tbody><tr id="row45029556254"><td class="cellrowborder" valign="top" width="35.339999999999996%" headers="mcps1.2.3.1.1 "><p id="p1250235572516"><a name="p1250235572516"></a><a name="p1250235572516"></a>Static Provisioning</p>
</td>
<td class="cellrowborder" rowspan="3" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><a name="ul20322165912442"></a><a name="ul20322165912442"></a><ul id="ul20322165912442"><li>DPC/NFS 3/4.1</li><li>DPC is supported only in 8.1.2 and later versions.</li><li>NFS 4.1 is supported by 8.1.2 and later versions.</li><li>Only OceanStor Pacific series 8.2.0 and later versions support NFS over RDMA. When NFS over RDMA is used, only NFS 3 is supported.</li></ul>
</td>
</tr>
...
<tr id="row1050205518258"><td class="cellrowborder" valign="top" width="35.339999999999996%" headers="mcps1.2.3.1.1 "><p id="p1650211552251"><a name="p1650211552251"></a><a name="p1650211552251"></a>Expand Persistent Volume</p>
</td>
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p10114173084218"><a name="p10114173084218"></a><a name="p10114173084218"></a>Volumes created in Dynamic Provisioning or Manage Provisioning mode are supported.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p2011483094213"><a name="p2011483094213"></a><a name="p2011483094213"></a>Not supported</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p17294191134320"><a name="p17294191134320"></a><a name="p17294191134320"></a>Not supported</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p570871274311"><a name="p570871274311"></a><a name="p570871274311"></a>Not supported</p>
</td>
</tr>
<tr id="row135028553252"><td class="cellrowborder" valign="top" width="35.339999999999996%" headers="mcps1.2.3.1.1 "><p id="p65021755192513"><a name="p65021755192513"></a><a name="p65021755192513"></a>Clone Persistent Volume</p>
</td>
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p3642192024311"><a name="p3642192024311"></a><a name="p3642192024311"></a>Not supported</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p6869724164319"><a name="p6869724164319"></a><a name="p6869724164319"></a>Not supported</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p155031155122514"><a name="p155031155122514"></a><a name="p155031155122514"></a>Supported</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p1503125510250"><a name="p1503125510250"></a><a name="p1503125510250"></a>Supported</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p69001214125219"><a name="p69001214125219"></a><a name="p69001214125219"></a>RWO, ROX, RWX, and RWOP. RWOP is supported only in Kubernetes 1.22 or later.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p8503855132516"><a name="p8503855132516"></a><a name="p8503855132516"></a>Supported</p>
</td>
</tr>
<tr id="row950335510253"><td class="cellrowborder" valign="top" width="35.339999999999996%" headers="mcps1.2.3.1.1 "><p id="p850315518253"><a name="p850315518253"></a><a name="p850315518253"></a>Soft and hard quotas</p>
</td>
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p105891507518"><a name="p105891507518"></a><a name="p105891507518"></a>Supported</p>
</td>
</tr>
<tr id="row7503185592511"><td class="cellrowborder" valign="top" width="35.339999999999996%" headers="mcps1.2.3.1.1 "><p id="p3503185514257"><a name="p3503185514257"></a><a name="p3503185514257"></a>Storage multi-tenant</p>
</td>
<td class="cellrowborder" valign="top" width="64.66%" headers="mcps1.2.3.1.2 "><p id="p14871012588"><a name="p14871012588"></a><a name="p14871012588"></a>Supported</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p17874257145"><a name="p17874257145"></a><a name="p17874257145"></a>√</p>
</td>
</tr>
