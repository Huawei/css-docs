...
<table><thead align="left"><tr id="row6996173914451"><th class="cellrowborder" valign="top" width="21.36%" id="mcps1.2.5.1.1"><p id="p199961439154519"><a name="p199961439154519"></a><a name="p199961439154519"></a>Feature</p>
</th>
<th class="cellrowborder" valign="top" width="20.43%" id="mcps1.2.5.1.2"><p id="p09961739124513"><a name="p09961739124513"></a><a name="p09961739124513"></a>OceanStor V5</p>
</th>
<th class="cellrowborder" valign="top" width="27.810000000000002%" id="mcps1.2.5.1.3"><p id="p1699615397457"><a name="p1699615397457"></a><a name="p1699615397457"></a>OceanStor</p>
</th>
...
<tbody><tr id="row1899683984519"><td class="cellrowborder" valign="top" width="21.36%" headers="mcps1.2.5.1.1 "><p id="p899653994514"><a name="p899653994514"></a><a name="p899653994514"></a>Static Provisioning</p>
</td>
<td class="cellrowborder" rowspan="3" valign="top" width="20.43%" headers="mcps1.2.5.1.2 "><p id="p9633201715"><a name="p9633201715"></a><a name="p9633201715"></a>NFS 3</p>
</td>
<td class="cellrowborder" rowspan="3" valign="top" width="27.810000000000002%" headers="mcps1.2.5.1.3 "><a name="ul5142135920"></a><a name="ul5142135920"></a><ul id="ul5142135920"><li>NFS 3/4.0/4.1/4.2</li><li>NFS over RDMA is supported only in 6.1.7 and later versions.</li><li>NFS 4.2 is supported only in 6.1.8 and later versions.</li></ul>
</td>
<td class="cellrowborder" rowspan="3" valign="top" width="30.4%" headers="mcps1.2.5.1.4 "><a name="ul1321316916219"></a><a name="ul1321316916219"></a><ul id="ul1321316916219"><li>NFS 3/4.0/4.1/4.2/NFS+</li><li>NFS 4.1 is supported only in 6.1.3 and later versions.</li><li>NFS over RDMA is supported only in 6.1.7 and later versions.</li><li>NFS 4.2 is supported only in 6.1.8 and later versions.</li><li>NFS+ is supported only in 6.1.7 and later versions.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.5.1.2 "><p id="p149971339154511"><a name="p149971339154511"></a><a name="p149971339154511"></a>Supported</p>
</td>
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p199713910459"><a name="p199713910459"></a><a name="p199713910459"></a>Supported only in 6.1.5 and later versions</p>
</td>
</tr>
...
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p17444111738"><a name="p17444111738"></a><a name="p17444111738"></a>Only 6.1.5 and later versions support volumes created in Dynamic Provisioning or Manage Provisioning mode.</p>
</td>
</tr>
...
<td class="cellrowborder" colspan="3" valign="top" headers="mcps1.2.5.1.2 mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p7539162811719"><a name="p7539162811719"></a><a name="p7539162811719"></a>Not supported</p>
</td>
</tr>
...
<td class="cellrowborder" colspan="3" valign="top" headers="mcps1.2.5.1.2 mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p69001214125219"><a name="p69001214125219"></a><a name="p69001214125219"></a>RWO, ROX, RWX, and RWOP. RWOP is supported only in Kubernetes 1.22 or later.</p>
</td>
</tr>
...
<td class="cellrowborder" colspan="3" valign="top" headers="mcps1.2.5.1.2 mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p1374918324264"><a name="p1374918324264"></a><a name="p1374918324264"></a>Supported. Only system users can configure QoS.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.5.1.2 "><p id="p49831014582"><a name="p49831014582"></a><a name="p49831014582"></a>Not supported</p>
</td>
...
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p794313221284"><a name="p794313221284"></a><a name="p794313221284"></a>Only the HyperMetro active-active (AA) mode is supported.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.5.1.2 "><p id="p15191349103613"><a name="p15191349103613"></a><a name="p15191349103613"></a>Supported</p>
</td>
<td class="cellrowborder" colspan="2" valign="top" headers="mcps1.2.5.1.3 mcps1.2.5.1.4 "><p id="p165451751102711"><a name="p165451751102711"></a><a name="p165451751102711"></a>Supported in 6.1.3 and later versions</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p170mcpsimp"><a name="p170mcpsimp"></a><a name="p170mcpsimp"></a>√ (RWX/RWO/ROX/RWOP. RWOP is supported only in Kubernetes 1.22 or later.)</p>
</td>
</tr>
