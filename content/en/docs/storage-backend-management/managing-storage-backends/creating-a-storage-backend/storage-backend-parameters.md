...
<td class="cellrowborder" valign="top" width="27.72277227722772%" headers="mcps1.2.6.1.5 "><a name="ul96961628201612"></a><a name="ul96961628201612"></a><ul id="ul96961628201612"><li>If the connected backend is OceanStor or OceanStor Dorado storage and resources need to be provisioned under a specified vStore, set this parameter to the URL of the logical management port of the vStore.</li><li>If the management URL is of the IPv6 type, the URL format is <strong id="b249418203236"><a name="b249418203236"></a><a name="b249418203236"></a>https://[</strong><em id="i10947153716237"><a name="i10947153716237"></a><a name="i10947153716237"></a>IPv6 address</em><strong id="b1925162219234"><a name="b1925162219234"></a><a name="b1925162219234"></a>]:</strong><em id="i7817354232"><a name="i7817354232"></a><a name="i7817354232"></a>Port number</em>. Currently, only enterprise storage supports IPv6.</li></ul>
</td>
</tr>
...
<a name="ul1866117213113"></a><a name="ul1866117213113"></a><ul id="ul1866117213113"><li>Multiple ports can be configured if the protocol is <strong id="b843823402510"><a name="b843823402510"></a><a name="b843823402510"></a>iscsi</strong>, <strong id="b2095618356251"><a name="b2095618356251"></a><a name="b2095618356251"></a>roce</strong>, or <strong id="b393510379253"><a name="b393510379253"></a><a name="b393510379253"></a>nfs+</strong>.</li><li>If the protocol is <strong id="b16699145512512"><a name="b16699145512512"></a><a name="b16699145512512"></a>nfs</strong>, only one port can be configured.</li><li>If the protocol is <strong id="b197831540152613"><a name="b197831540152613"></a><a name="b197831540152613"></a>fc</strong>, <strong id="b359164232615"><a name="b359164232615"></a><a name="b359164232615"></a>fc-nvme</strong>, or <strong id="b830517431264"><a name="b830517431264"></a><a name="b830517431264"></a>dpc</strong>, service ports do not need to be configured.</li><li>If the protocol is <strong id="b17805131212711"><a name="b17805131212711"></a><a name="b17805131212711"></a>scsi</strong>, the port is in dictionary format where the key indicates the name of the host where the VBS client is deployed and the value indicates the IP address of the host where the VBS client is deployed.</li></ul>
</td>
...
<tr id="row51574418229"><td class="cellrowborder" valign="top" width="13.86138613861386%" headers="mcps1.2.6.1.1 "><p id="p3158541228"><a name="p3158541228"></a><a name="p3158541228"></a>authenticationMode</p>
</td>
<td class="cellrowborder" valign="top" width="32.67326732673267%" headers="mcps1.2.6.1.2 "><p id="p31581743223"><a name="p31581743223"></a><a name="p31581743223"></a>Authentication mode for logging in to a storage backend.</p>
...
<td class="cellrowborder" valign="top" width="13.86138613861386%" headers="mcps1.2.6.1.3 "><p id="p315894172213"><a name="p315894172213"></a><a name="p315894172213"></a>No</p>
</td>
<td class="cellrowborder" valign="top" width="11.881188118811878%" headers="mcps1.2.6.1.4 "><p id="p121587482213"><a name="p121587482213"></a><a name="p121587482213"></a>local</p>
</td>
<td class="cellrowborder" valign="top" width="27.72277227722772%" headers="mcps1.2.6.1.5 "><a name="ul9756135236"></a><a name="ul9756135236"></a><ul id="ul9756135236"><li>LDAP authentication is supported when <strong id="b12527114516277"><a name="b12527114516277"></a><a name="b12527114516277"></a>storage</strong> is set to <strong id="b9527184552715"><a name="b9527184552715"></a><a name="b9527184552715"></a>oceanstor-san</strong>, <strong id="b20527745182720"><a name="b20527745182720"></a><a name="b20527745182720"></a>oceanstor-nas</strong>, or <strong id="b115275454277"><a name="b115275454277"></a><a name="b115275454277"></a>oceanstor-dtree</strong>.</li><li>When Huawei enterprise storage is OceanStor V5, the ID of the LDAP domain authentication server must be 0.</li></ul>
</td>
</tr>
</tbody>
</table>
