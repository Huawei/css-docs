...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p17706140171015"><a name="p17706140171015"></a><a name="p17706140171015"></a>The value is fixed to <strong id="b18553612125811"><a name="b18553612125811"></a><a name="b18553612125811"></a>oceanstor-nas</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p1731243191120"><a name="p1731243191120"></a><a name="p1731243191120"></a>If resources need to be provisioned to a specified vStore, set this parameter to the logical management port URL of the specified vStore.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p7680150182416"><a name="p7680150182416"></a><a name="p7680150182416"></a>The value is fixed to <strong id="b2366154115810"><a name="b2366154115810"></a><a name="b2366154115810"></a>nfs</strong>. Ensure that an NFS client tool has been installed on the connected compute node.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul73520114122"></a><a name="ul73520114122"></a><ul id="ul73520114122"><li>If a vStore is used to connect to a backend, <strong id="b132751385592"><a name="b132751385592"></a><a name="b132751385592"></a>portals</strong> must be set to the logical port information of the vStore.</li><li>You can enter a domain name address.</li><li>Only one port can be configured.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p7363204412133"><a name="p7363204412133"></a><a name="p7363204412133"></a>The value ranges from <strong id="b12556525304322"><a name="b12556525304322"></a><a name="b12556525304322"></a>1</strong> to <strong id="b12786570024322"><a name="b12786570024322"></a><a name="b12786570024322"></a>30</strong>. If this parameter is not set or the value is not in the specified range, the default value <strong id="b1940695174322"><a name="b1940695174322"></a><a name="b1940695174322"></a>30</strong> is used.</p>
</td>
</tr>
</tbody>
</table>
