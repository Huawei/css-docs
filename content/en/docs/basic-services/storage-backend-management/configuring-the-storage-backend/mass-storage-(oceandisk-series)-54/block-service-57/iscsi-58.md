...
<td class="cellrowborder" valign="top" width="37.771685921284515%" headers="mcps1.2.6.1.2 "><p id="p11239105713615"><a name="p11239105713615"></a><a name="p11239105713615"></a>Storage backend name. The value can contain a maximum of 63 characters, including lowercase letters, digits, and hyphens (-). It must start with a letter or digit.</p>
</td>
<td class="cellrowborder" valign="top" width="7.1176816134717065%" headers="mcps1.2.6.1.3 "><p id="p112390571467"><a name="p112390571467"></a><a name="p112390571467"></a>Yes</p>
</td>
<td class="cellrowborder" valign="top" width="6.8533385549246155%" headers="mcps1.2.6.1.4 "><p id="p102392571061"><a name="p102392571061"></a><a name="p102392571061"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p223912574619"><a name="p223912574619"></a><a name="p223912574619"></a>Ensure that the storage backend name is unique.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul555819319152"></a><a name="ul555819319152"></a><ul id="ul555819319152"><li>The value is fixed to <strong id="b161074716951923"><a name="b161074716951923"></a><a name="b161074716951923"></a>iscsi</strong>.</li><li>Ensure that an iSCSI client has been installed on the connected compute node.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p18274818430"><a name="p18274818430"></a><a name="p18274818430"></a>Multiple ports can be configured.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p7363204412133"><a name="p7363204412133"></a><a name="p7363204412133"></a>The value ranges from <strong id="b6113634514323"><a name="b6113634514323"></a><a name="b6113634514323"></a>1</strong> to <strong id="b15907226784323"><a name="b15907226784323"></a><a name="b15907226784323"></a>30</strong>. If this parameter is not set or the value is not in the specified range, the default value <strong id="b16613263454323"><a name="b16613263454323"></a><a name="b16613263454323"></a>30</strong> is used.</p>
</td>
</tr>
</tbody>
</table>
