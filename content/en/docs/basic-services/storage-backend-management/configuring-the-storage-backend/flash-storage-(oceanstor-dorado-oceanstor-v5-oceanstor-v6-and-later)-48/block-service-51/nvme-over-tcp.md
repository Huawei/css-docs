---
title: "NVMe over TCP"
linkTitle: "NVMe over TCP"
description: 
weight: 4
---

This section describes how to create a storage backend of the NVMe over TCP protocol type.
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul96961628201612"></a><a name="ul96961628201612"></a><ul id="ul96961628201612"><li>If the management URL is of the IPv6 type, the URL format is <strong id="b2784802529"><a name="b2784802529"></a><a name="b2784802529"></a>https://[</strong><em id="i1778470175214"><a name="i1778470175214"></a><a name="i1778470175214"></a>IPv6 address</em><strong id="b178410135218"><a name="b178410135218"></a><a name="b178410135218"></a>]:</strong><em id="i107845012523"><a name="i107845012523"></a><a name="i107845012523"></a>Port number</em>.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><a name="ul555819319152"></a><a name="ul555819319152"></a><ul id="ul555819319152"><li>The value is fixed at <strong id="b13442121385210"><a name="b13442121385210"></a><a name="b13442121385210"></a>tcp-nvme</strong>.</li><li>Ensure that the nvme-cli tool has been installed on the compute node to be connected. The supported nvme-cli tool version is 2.0 and later.</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p7363204412133"><a name="p7363204412133"></a><a name="p7363204412133"></a>The value ranges from <strong id="b7441185645216"><a name="b7441185645216"></a><a name="b7441185645216"></a>1</strong> to <strong id="b844125618527"><a name="b844125618527"></a><a name="b844125618527"></a>30</strong>. If this parameter is not set or the value is not in the specified range, the default value <strong id="b544115563522"><a name="b544115563522"></a><a name="b544115563522"></a>30</strong> is used.</p>
</td>
</tr>
...
<a name="ul41301430359"></a><a name="ul41301430359"></a><ul id="ul41301430359"><li><strong id="b1284315419534"><a name="b1284315419534"></a><a name="b1284315419534"></a>local</strong>: local authentication</li><li><strong id="b71511365534"><a name="b71511365534"></a><a name="b71511365534"></a>ldap</strong>: LDAP authentication</li></ul>
</td>
...
<td class="cellrowborder" valign="top" width="34.9911885647151%" headers="mcps1.2.6.1.5 "><p id="p24702584253"><a name="p24702584253"></a><a name="p24702584253"></a>-</p>
</td>
</tr>
</tbody>
</table>
