...
If a container uses OceanStor A series storage and the storage supports KV cache, you can refer to the following configuration example for the NFS protocol. KV cache also supports the DTFS protocol. For details about the configuration, see the parameter description.
...
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p492361153210"><a name="p492361153210"></a><a name="p492361153210"></a>DataTurbo user who can access the DataTurbo share. This parameter is mandatory when the DataTurbo (DTFS) protocol is used.</p>
</td>
...
<a name="ul7370193012510"></a><a name="ul7370193012510"></a><ul id="ul7370193012510"><li><strong id="b231201243618"><a name="b231201243618"></a><a name="b231201243618"></a>"true"</strong>: disables volume capacity verification.</li><li><strong id="b22430852143652"><a name="b22430852143652"></a><a name="b22430852143652"></a>"false"</strong>: enables volume capacity verification.</li></ul>
<div class="notice" id="note163681158114916"><a name="note163681158114916"></a><a name="note163681158114916"></a><span class="noticetitle"> NOTICE: </span><div class="noticebody"><p id="p6368158104913"><a name="p6368158104913"></a><a name="p6368158104913"></a>When Red Hat OpenShift Virtualization is used to connect to CSI, this parameter must be set to <strong id="b182020295175352"><a name="b182020295175352"></a><a name="b182020295175352"></a>"true"</strong>.</p>
</div></div>
</td>
...
<tr id="row2050315710157"><td class="cellrowborder" valign="top" width="18.481557577536446%" headers="mcps1.2.7.1.1 "><p id="p8152112782220"><a name="p8152112782220"></a><a name="p8152112782220"></a>parameters.enableKVCache</p>
</td>
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p19628175610227"><a name="p19628175610227"></a><a name="p19628175610227"></a>Whether to create a KV cache store.</p>
<a name="ul277414531950"></a><a name="ul277414531950"></a><ul id="ul277414531950"><li><strong id="b1230217327308"><a name="b1230217327308"></a><a name="b1230217327308"></a>"false"</strong>: disable</li><li><strong id="b15636133313306"><a name="b15636133313306"></a><a name="b15636133313306"></a>"true"</strong>: enable</li></ul>
</td>
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p31521527152220"><a name="p31521527152220"></a><a name="p31521527152220"></a>No</p>
</td>
<td class="cellrowborder" valign="top" width="8.453184619900206%" headers="mcps1.2.7.1.4 "><p id="p19523121212310"><a name="p19523121212310"></a><a name="p19523121212310"></a>"false"</p>
</td>
<td class="cellrowborder" valign="top" width="7.35740142843166%" headers="mcps1.2.7.1.5 "><p id="p20508115831514"><a name="p20508115831514"></a><a name="p20508115831514"></a>No</p>
</td>
<td class="cellrowborder" valign="top" width="35.7694941786518%" headers="mcps1.2.7.1.6 "><p id="p119704559154"><a name="p119704559154"></a><a name="p119704559154"></a>If this parameter is set to <strong id="b07031738173820"><a name="b07031738173820"></a><a name="b07031738173820"></a>"true"</strong>, <strong id="b380114383812"><a name="b380114383812"></a><a name="b380114383812"></a>parameters.applicationType</strong> can only be set to <strong id="b19320248163812"><a name="b19320248163812"></a><a name="b19320248163812"></a>NAS_AI_Inference</strong> or left empty.</p>
</td>
</tr>
<tr id="row1278191416158"><td class="cellrowborder" valign="top" width="18.481557577536446%" headers="mcps1.2.7.1.1 "><p id="p19200143115490"><a name="p19200143115490"></a><a name="p19200143115490"></a>parameters.enableTimeAwareGc</p>
</td>
<td class="cellrowborder" valign="top" width="23.089717248801485%" headers="mcps1.2.7.1.2 "><p id="p220093184917"><a name="p220093184917"></a><a name="p220093184917"></a>Whether to enable proactive clearing for a KV cache.</p>
<a name="ul240061210515"></a><a name="ul240061210515"></a><ul id="ul240061210515"><li><strong id="b16932632193020"><a name="b16932632193020"></a><a name="b16932632193020"></a>"false"</strong>: disable</li><li><strong id="b263023414300"><a name="b263023414300"></a><a name="b263023414300"></a>"true"</strong>: enable</li></ul>
</td>
<td class="cellrowborder" valign="top" width="6.848644946678408%" headers="mcps1.2.7.1.3 "><p id="p1920063144913"><a name="p1920063144913"></a><a name="p1920063144913"></a>No</p>
</td>
<td class="cellrowborder" valign="top" width="8.453184619900206%" headers="mcps1.2.7.1.4 "><p id="p1139143413118"><a name="p1139143413118"></a><a name="p1139143413118"></a>"false"</p>
</td>
<td class="cellrowborder" valign="top" width="7.35740142843166%" headers="mcps1.2.7.1.5 "><p id="p1200113114920"><a name="p1200113114920"></a><a name="p1200113114920"></a>No</p>
</td>
<td class="cellrowborder" valign="top" width="35.7694941786518%" headers="mcps1.2.7.1.6 "><p id="p13970555181513"><a name="p13970555181513"></a><a name="p13970555181513"></a>No matter whether this parameter is set to <strong id="b10277103522519"><a name="b10277103522519"></a><a name="b10277103522519"></a>"true"</strong> or <strong id="b2033630347113942"><a name="b2033630347113942"></a><a name="b2033630347113942"></a>"false"</strong>, the background clears the KV cache when the memory store capacity is insufficient. When this parameter is set to <strong id="b1743112697113942"><a name="b1743112697113942"></a><a name="b1743112697113942"></a>"true"</strong>, the background clears the expired KV cache.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="8.453184619900206%" headers="mcps1.2.7.1.4 "><p id="p9634726031"><a name="p9634726031"></a><a name="p9634726031"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="7.35740142843166%" headers="mcps1.2.7.1.5 "><p id="p7661579277"><a name="p7661579277"></a><a name="p7661579277"></a>No</p>
</td>
<td class="cellrowborder" valign="top" width="35.7694941786518%" headers="mcps1.2.7.1.6 "><p id="p209709556158"><a name="p209709556158"></a><a name="p209709556158"></a>This parameter is mandatory when <strong id="b77118582408"><a name="b77118582408"></a><a name="b77118582408"></a>parameters.enableTimeAwareGc</strong> is set to <strong id="b629616020419"><a name="b629616020419"></a><a name="b629616020419"></a>true</strong>.</p>
</td>
</tr>
</tbody>
</table>
