...
<div class="notice" id="note18836205319216"><a name="note18836205319216"></a><a name="note18836205319216"></a><span class="noticetitle"> NOTICE: </span><div class="noticebody"><p id="p3836205312217"><a name="p3836205312217"></a><a name="p3836205312217"></a>When Ubuntu 22.04 LTS with a kernel version earlier than 5.15.194 is used to interconnect with CSI, the XFS file system cannot be mounted due to a kernel bug.</p>
</div></div>
</td>
</tr>
