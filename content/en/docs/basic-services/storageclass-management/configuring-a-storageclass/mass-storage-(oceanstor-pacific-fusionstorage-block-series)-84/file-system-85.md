...
<td class="cellrowborder" valign="top" width="35.7694941786518%" headers="mcps1.2.7.1.6 "><p id="p159151023181412"><a name="p159151023181412"></a><a name="p159151023181412"></a>The value is fixed at <strong id="b980715176283"><a name="b980715176283"></a><a name="b980715176283"></a>fs</strong>.</p>
</td>
</tr>
...
<a name="ul7370193012510"></a><a name="ul7370193012510"></a><ul id="ul7370193012510"><li><strong id="b9931850173410"><a name="b9931850173410"></a><a name="b9931850173410"></a>"true"</strong>: disables volume capacity verification.</li><li><strong id="b120405248343653"><a name="b120405248343653"></a><a name="b120405248343653"></a>"false"</strong>: enables volume capacity verification.</li></ul>
<div class="notice" id="note163681158114916"><a name="note163681158114916"></a><a name="note163681158114916"></a><span class="noticetitle"> NOTICE: </span><div class="noticebody"><p id="p6368158104913"><a name="p6368158104913"></a><a name="p6368158104913"></a>When Red Hat OpenShift Virtualization is used to connect to CSI, this parameter must be set to <strong id="b113530375275354"><a name="b113530375275354"></a><a name="b113530375275354"></a>"true"</strong>.</p>
</div></div>
</td>
...
<p id="p328516567514"><a name="p328516567514"></a><a name="p328516567514"></a><strong id="b1829141763615"><a name="b1829141763615"></a><a name="b1829141763615"></a>nfsvers</strong>: protocol version for NFS mounting. The value can be <strong id="b13379111624115"><a name="b13379111624115"></a><a name="b13379111624115"></a>3</strong> or <strong id="b9379171617418"><a name="b9379171617418"></a><a name="b9379171617418"></a>4.1</strong>.</p>
</td>
...
<p id="p13285856115110"><a name="p13285856115110"></a><a name="p13285856115110"></a>If the NFS version is specified for mounting, NFS 3 and 4.1 protocols are supported (the protocol must be supported and enabled on storage devices).</p>
</td>
</tr>
