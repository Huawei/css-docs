...
2.  Uninstall CSI. For details, see  [Procedure](/docs/installation-and-deployment/csi/uninstallation/uninstallation-using-helm/uninstalling-huawei-csi-on-cce-or-cce-agile#section1489941282414).
3.  Reinstall CSI of the source version. For details, see  [Installing Huawei CSI on the CCE or CCE Agile Platform](/docs/installation-and-deployment/csi/installation/installation-using-helm/installing-huawei-csi-on-the-cce-or-cce-agile-platform).
