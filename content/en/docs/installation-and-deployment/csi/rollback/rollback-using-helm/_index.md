...
If CSI fails to be upgraded from 2._x_  or 3._x_  to  4.9.0  and needs to be rolled back, uninstall CSI by referring to  [Uninstallation Using Helm](/docs/installation-and-deployment/csi/uninstallation/uninstallation-using-helm)  and then download and install CSI of the source version.
