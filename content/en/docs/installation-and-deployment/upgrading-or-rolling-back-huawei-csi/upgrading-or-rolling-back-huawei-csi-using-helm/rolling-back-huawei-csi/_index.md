...
If CSI fails to be upgraded from 2._x_  or 3._x_  to  4.8.0  and needs to be rolled back, uninstall CSI by referring to  [Uninstalling Huawei CSI Using Helm](/docs/installation-and-deployment/uninstalling-huawei-csi/uninstalling-huawei-csi-using-helm)  and then download and install CSI of the source version.
