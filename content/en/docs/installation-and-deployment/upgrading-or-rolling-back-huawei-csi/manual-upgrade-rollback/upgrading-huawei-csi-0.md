...
## Upgrading CSI from 2.x or 3.x to  4.8.0{#section260220843210}

To upgrade CSI from 2._x_  or 3._x_  to  4.8.0, perform the following operations:
...
## Upgrading CSI from 4.x to  4.8.0{#section173369363219}

To upgrade CSI from 4._x_  to  4.8.0, perform the following operations:
